...
Revision ID: 520aff94ac19
Revises: 
Create Date: 2022-01-23 12:54:40.557844
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['offset_transactions_id'], ['transactions.id'], use_alter=True),
    sa.PrimaryKeyConstraint('id')
    )
